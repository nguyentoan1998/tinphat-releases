// Invoices Menu — Choose between Sales Invoices and Purchase Receipts
...
import { FileText, Receipt, ChevronRight, ChevronLeft, ArrowUp, ArrowDown } from 'lucide-react-native';
...
const MENU_ITEMS = [
    { id: 'sales-invoices', title: 'Hoá đơn bán hàng', subtitle: 'Lập & quản lý hoá đơn bán', Icon: FileText, ArrowIcon: ArrowUp, gradient: ['#0EA5E9', '#38BDF8'] as const, route: '/sales/invoices', accentColor: '#38BDF8' },
    { id: 'purchase-receipts', title: 'Phiếu nhập hàng', subtitle: 'Nhận hàng từ nhà cung cấp', Icon: Receipt, ArrowIcon: ArrowDown, gradient: ['#F59E0B', '#FBBF24'] as const, route: '/purchase/receipts', accentColor: '#FBBF24' },
];

export default function InvoicesMenuScreen() {
        ...
        <View style={s.root}>
            ...
            <SafeAreaView style={s.safe} edges={['top']}>
                <Animated.View entering={FadeInUp.duration(Timings.entrance)} style={s.header}>
                    ...
                    <View>
                        <Text style={[s.headerTitle, { color: colors.textPrimary }]}>Hoá đơn</Text>
                        <Text style={[s.headerSub, { color: colors.textMuted }]}>Chọn loại hoá đơn</Text>
                    </View>
                </Animated.View>
                <View style={s.cards}>
                                ...
                                <View style={[s.cardInner, { backgroundColor: colors.cardBg }]}>
                                    ...
                                    <View style={s.cardText}>
                                        <View style={s.titleRow}>
                                            ...
                                            <item.ArrowIcon size={16} color={item.accentColor} />
                                        </View>
