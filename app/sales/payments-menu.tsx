// Payments Menu — Choose between Receivables and Payables
...
import { ArrowDownToLine, ArrowUpFromLine, ChevronRight, ChevronLeft } from 'lucide-react-native';
...
const MENU_ITEMS = [
    { id: 'receivables', title: 'Công nợ phải thu', subtitle: 'Theo dõi tiền khách hàng còn nợ', Icon: ArrowDownToLine, gradient: ['#10B981', '#34D399'] as const, route: '/sales/receivables' },
    { id: 'payables', title: 'Công nợ phải trả', subtitle: 'Theo dõi tiền nợ nhà cung cấp', Icon: ArrowUpFromLine, gradient: ['#EF4444', '#F87171'] as const, route: '/purchase/payables' },
];
        ...
        <View style={s.root}>
            ...
            <SafeAreaView style={s.safe} edges={['top']}>
                <Animated.View entering={FadeInUp.duration(Timings.entrance)} style={s.header}>
                    ...
                    <View>
                        <Text style={[s.headerTitle, { color: colors.textPrimary }]}>Thanh toán</Text>
                        <Text style={[s.headerSub, { color: colors.textMuted }]}>Công nợ phải thu & phải trả</Text>
                    </View>
                </Animated.View>
                <View style={s.cards}>
