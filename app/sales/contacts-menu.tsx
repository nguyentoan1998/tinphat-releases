// Contacts Menu — Choose between Customers and Suppliers
...
import { Users, Truck, ChevronRight, ChevronLeft } from 'lucide-react-native';
...
const MENU_ITEMS = [
    { id: 'customers', title: 'Khách hàng', subtitle: 'Danh sách khách hàng mua sản phẩm', Icon: Users, gradient: ['#14B8A6', '#5EEAD4'] as const, route: '/sales/customers' },
    { id: 'suppliers', title: 'Nhà cung cấp', subtitle: 'Danh sách NCC nguyên vật liệu', Icon: Truck, gradient: ['#F59E0B', '#FBBF24'] as const, route: '/purchase/suppliers' },
];

export default function ContactsMenuScreen() {
        ...
        <View style={s.root}>
            ...
            <SafeAreaView style={s.safe} edges={['top']}>
                <Animated.View entering={FadeInUp.duration(Timings.entrance)} style={s.header}>
                    ...
                    <View>
                        <Text style={[s.headerTitle, { color: colors.textPrimary }]}>Đối tác</Text>
                        <Text style={[s.headerSub, { color: colors.textMuted }]}>Khách hàng & Nhà cung cấp</Text>
                    </View>
                </Animated.View>
                <View style={s.cards}>
