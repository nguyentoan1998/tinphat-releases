// Orders Menu — Choose between Sales Orders and Purchase Orders
...
import { ShoppingBag, ShoppingCart, ChevronRight, ChevronLeft, ArrowDown, ArrowUp } from 'lucide-react-native';
...
const MENU_ITEMS = [
    { id: 'sales', title: 'Đơn bán hàng', subtitle: 'Quản lý đơn đặt hàng từ khách', Icon: ShoppingBag, ArrowIcon: ArrowUp, gradient: ['#10B981', '#34D399'] as const, route: '/sales/orders', accentColor: '#34D399' },
    { id: 'purchase', title: 'Đơn mua hàng', subtitle: 'Quản lý đơn mua NVL từ nhà cung cấp', Icon: ShoppingCart, ArrowIcon: ArrowDown, gradient: ['#6366F1', '#818CF8'] as const, route: '/purchase/orders', accentColor: '#818CF8' },
];
        ...
        <View style={s.root}>
            ...
            <SafeAreaView style={s.safe} edges={['top']}>
                <Animated.View entering={FadeInUp.duration(Timings.entrance)} style={s.header}>
                    ...
                    <View>
                        <Text style={[s.headerTitle, { color: colors.textPrimary }]}>Đơn hàng</Text>
                        <Text style={[s.headerSub, { color: colors.textMuted }]}>Chọn loại đơn hàng</Text>
                    </View>
                </Animated.View>
                <View style={s.cards}>
