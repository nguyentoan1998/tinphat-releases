            ...
            <View style={s.card}>
                <View style={s.cardInner}>
                    ...
                    <View style={s.cardBottom}>
                        ...
                        <View style={[s.qtyChip, { backgroundColor: 'rgba(14,165,233,0.12)' }]}>
...
const s = StyleSheet.create({
    ...
    qtyText: { fontSize: 14, fontWeight: FontWeights.bold, color: '#0EA5E9' },
    qtyLabel: { fontSize: 11, color: '#0EA5E9', opacity: 0.7 },
